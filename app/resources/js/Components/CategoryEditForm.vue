  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-slate-500 overflow-hidden shadow-sm sm:rounded-lg">
        <form @submit.prevent="submit" :key="category.id">
          <div class="flex flex-wrap p-6 bg-slate-500 border-b border-gray-200">
            ...
            <div class="m-4">
              <InputLabel for="include_in_br" value="Show this category in the expense breakdown piechart?"/>
              <Checkbox id="include_in_br" v-model:checked="form.include_in_expense_breakdown" name="include_in_expense_breakdown"/>
              <InputError class="mt-2" :message="form.errors.include_in_expense_breakdown" />
            </div>
          </div>
          ...
          <div class="flex flex-wrap p-6 bg-slate-500 border-gray-200">
            ...
            <ConfirmationModal :show="catBeingDeleted != null" @close="catBeingDeleted = null">
              <template #title>
                Delete Category
              </template>
