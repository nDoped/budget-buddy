    ...
    public function rules(Request $request)
    {
        ...
        case 'transactions.update':
            $ret = [
                ...
                'new_images.*.ai_analysis' => [ 'nullable' ],
                'uploaded_file' => ['nullable', 'max:1024', 'mimes:jpeg,png,doc,docx,pdf'],
                'tax' => [ 'nullable', 'numeric', 'gte:0' ],
                'line_items' => [ 'nullable', 'array' ],
                'line_items.*.price' => [ 'required', 'numeric' ],
                'line_items.*.cat_data.name' => [ 'required' ],
                'line_items.*.cat_data.cat_id' => [ 'nullable', 'numeric' ],
                'line_items.*.cat_data.hex_color' => [ 'nullable', 'string' ],
                'line_items.*.cat_data.cat_type_id' => [ 'nullable', 'numeric' ],
                'line_items.*.cat_data.cat_type_name' => [ 'nullable', 'string' ],
                'line_items.*.cat_data.cat_subtype_id' => [ 'nullable', 'numeric' ],
                'categories' => [ 'nullable' ],
